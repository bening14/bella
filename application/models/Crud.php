...
class Crud extends CI_Model
{
    ...
    private function _get_datatables_query($table, $select, $column_order, $column_search, $order, $where, $join)
    {
        $this->db->select($select);
        $this->db->from($table);
        if (!empty($join)) {
    ...
    function get_datatables($table, $select, $column_order, $column_search, $order = null, $where = null, $join = null)
    {
        $this->_get_datatables_query($table, $select, $column_order, $column_search, $order, $where, $join);
        if ($_POST['length'] != -1)
            $this->db->limit($_POST['length'], $_POST['start']);
        return $this->db->get()->result();
    }

    function count_filtered($table, $select, $column_order, $column_search, $order = null, $where = null, $join = null)
    {
        $this->_get_datatables_query($table, $select, $column_order, $column_search, $order, $where, $join);
        $query = $this->db->get();
